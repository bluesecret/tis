...
INSERT INTO `sys_user` VALUES(1879052333397053440,'admin','$2a$10$hy5Db5pSPKKVxK4kLQiSw.S1o/OA5ZN.TNneLr83hokNBueF3bJIa','管理员',1879052333397053443,NULL,0,0,NULL,NULL,NULL,1879052333397053440,CURDATE(),1879052333397053440,CURDATE(),1);
...
CREATE TABLE `zz_online_form_user_ext` (
                                           ...
                                           `extra_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '扩展信息',
                                           PRIMARY KEY (`id`) USING BTREE,
