...
INSERT INTO `sys_menu` VALUES(1882452385217908814,1882320825722343424,'检查结果',3,NULL,NULL,NULL,NULL,NULL,2,NULL,'{"menuCode":"formTisPatInfo:formTisPatInfo:editTisPatInfo","permCodeList":["tisPatInfo.add","tisPatInfo.update","tisPatInfo.view"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
