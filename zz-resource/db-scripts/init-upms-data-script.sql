...
INSERT INTO `sys_menu` VALUES(1887482403153252352,1882320660345131008,'检查结果',1,'formTisPatResult',NULL,NULL,NULL,NULL,300,NULL,'{}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1887482464587223120,1887482403153252352,'显示',3,NULL,NULL,NULL,NULL,NULL,1,NULL,'{"menuCode":"formTisPatResult:formTisPatResult","permCodeList":["tisPatResult.view"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1887482464587223121,1887482403153252352,'新建',3,NULL,NULL,NULL,NULL,NULL,2,NULL,'{"menuCode":"formTisPatResult:formTisPatResult:addTisPatResult","permCodeList":["tisPatResult.add","tisPatResult.update","tisPatResult.view"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1887482464587223122,1887482403153252352,'编辑',3,NULL,NULL,NULL,NULL,NULL,3,NULL,'{"menuCode":"formTisPatResult:formTisPatResult:editTisPatResult","permCodeList":["tisPatResult.add","tisPatResult.update","tisPatResult.view"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1887482464587223123,1887482403153252352,'导出',3,NULL,NULL,NULL,NULL,NULL,4,NULL,'{"menuCode":"formTisPatResult:formTisPatResult:exportTisPatResult","permCodeList":["tisPatResult.export"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1887482464587223124,1887482403153252352,'导入',3,NULL,NULL,NULL,NULL,NULL,5,NULL,'{"menuCode":"formTisPatResult:formTisPatResult:importTisPatResult","permCodeList":["tisPatResult.import"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1887482464587223125,1887482403153252352,'删除',3,NULL,NULL,NULL,NULL,NULL,6,NULL,'{"menuCode":"formTisPatResult:formTisPatResult:deleteTisPatResult","permCodeList":["tisPatResult.delete"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
