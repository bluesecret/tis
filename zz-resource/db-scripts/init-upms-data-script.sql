...
INSERT INTO `sys_menu` VALUES(1882320959277371475,1882320825722343424,'显示',3,NULL,NULL,NULL,NULL,NULL,1,NULL,'{"menuCode":"formTisPatInfo:formTisPatInfo","permCodeList":["tisPatInfo.view"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1882320959277371476,1882320825722343424,'新建',3,NULL,NULL,NULL,NULL,NULL,2,NULL,'{"menuCode":"formTisPatInfo:formTisPatInfo:addTisPatInfo","permCodeList":["tisPatInfo.add","tisPatInfo.update","tisPatInfo.view"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1882320959277371477,1882320825722343424,'患者检测结果',3,NULL,NULL,NULL,NULL,NULL,3,NULL,'{"menuCode":"formTisPatInfo:formTisPatInfo:listTisPatResult","permCodeList":["tisPatResult.add","tisPatResult.delete","tisPatResult.export","tisPatResult.import","tisPatResult.update","tisPatResult.view"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1882320959277371478,1882320825722343424,'编辑',3,NULL,NULL,NULL,NULL,NULL,4,NULL,'{"menuCode":"formTisPatInfo:formTisPatInfo:editTisPatInfo","permCodeList":["tisPatInfo.add","tisPatInfo.update","tisPatInfo.view"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1882320959277371479,1882320825722343424,'导出',3,NULL,NULL,NULL,NULL,NULL,5,NULL,'{"menuCode":"formTisPatInfo:formTisPatInfo:exportTisPatInfo","permCodeList":["tisPatInfo.export"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1882320959277371480,1882320825722343424,'导入',3,NULL,NULL,NULL,NULL,NULL,6,NULL,'{"menuCode":"formTisPatInfo:formTisPatInfo:importTisPatInfo","permCodeList":["tisPatInfo.import"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
INSERT INTO `sys_menu` VALUES(1882320959277371481,1882320825722343424,'删除',3,NULL,NULL,NULL,NULL,NULL,7,NULL,'{"menuCode":"formTisPatInfo:formTisPatInfo:deleteTisPatInfo","permCodeList":["tisPatInfo.delete"]}',1879052333397053440,CURDATE(),1879052333397053440,CURDATE());
