...
public class RedisKeyUtil {
    ...
    /**
     * 计算第三方用户授权信息的内部令牌的缓存键。
     *
     * @param token 换取第三方用户授权信息的内部令牌。
     */
    public static String makeOauthCodeKey(String token) {
        return "OAUTH_CODE:" + token;
    }
     ...
     */
    public static String makeUserFormExtKey(Long formId) {
        TokenData tokenData = TokenData.takeFromRequest();
        return "ONLINE_FORM_USER_EXT:" + tokenData.getUserId() + "--" + formId;
    }
