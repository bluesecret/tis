...
import io.wangk.peekaboo.common.core.annotation.EnableDataPerm;
...
public interface FlowWorkOrderMapper extends BaseDaoMapper<FlowWorkOrder> {
     ...
     *
     * @param flowWorkOrderFilter 主表过滤对象。
     * @param dataIdList          业务主键Id集合的过滤条件。
     * @param orderBy             排序字符串，order by从句的参数。
     * @return 对象列表。
     */
    List<FlowWorkOrder> getFlowWorkOrderListWithDataIds(
            @Param("flowWorkOrderFilter") FlowWorkOrder flowWorkOrderFilter,
            @Param("dataIdList") List<String> dataIdList,
