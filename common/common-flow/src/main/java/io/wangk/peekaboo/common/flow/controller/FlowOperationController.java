...
import io.wangk.peekaboo.common.flow.vo.FlowTaskCommentVo;
...
public class FlowOperationController {
    ...
    public ResponseResult<Void> fixAutoFlow(
        ...
        autoFlowHelper.trigger(transProducer);
        return ResponseResult.success();
    }
    ...
    public ResponseResult<MyPageData<Map<String, Object>>> listAllHistoricProcessInstance(
        ...
        Map<String, FlowEntry> flowEntryMap =
                flowEntryService.getInList(key, processDefinitionKeys)
        ...
        resultList.forEach(result -> {
            FlowEntry entry = flowEntryMap.get(result.get(key).toString());
