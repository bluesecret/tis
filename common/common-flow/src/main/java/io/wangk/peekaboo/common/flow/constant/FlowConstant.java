...
public class FlowConstant {
     ...
     * 流程实例中发起人用户的显示名。
     */
    public static final String PROC_INSTANCE_START_SHOW_NAME_VAR = "startShowName";
     ...
     * 流程用户任务待办之前的通知类型的Key。
     */
    public static final String USER_TASK_NOTIFY_MSG_KEY = "notifyMessage";
     ...
     * 自动化任务输出数据的KEY。
     */
    public static final String AUTO_FLOW_DATA_RESULT_KEY = "dataResult";

    /**
     * 自动化任务消息头，指定消息类型的KEY。
     */
    public static final String AUTO_FLOW_MESSAGE_TYPE_KEY = "AUTO_FLOW_MESSAGE_TYPE";

    /**
     * 自动化任务消息头，指定消息命令类型的KEY。
     */
    public static final String AUTO_FLOW_COMMAND_TYPE_KEY = "AUTO_FLOW_MESSAGE_COMMAND";
    /**
     * 自动化流程中消息消费数据变量Key。
     */
    public static final String AUTO_FLOW_CONSUME_MESSAGE_VAR = "autoFlowConsumeMessage";
