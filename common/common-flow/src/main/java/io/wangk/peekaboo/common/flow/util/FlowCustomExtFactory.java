...
public class FlowCustomExtFactory {
     ...
     * 获取有关业务数据的扩展帮助实现类。
     */
    private final BaseBusinessDataExtHelper businessDataExtHelper = new BaseBusinessDataExtHelper();

    /**
     * 获取有关在线表单业务数据的扩展帮助实现类。
     */
    private final BaseOnlineBusinessDataExtHelper onlineBusinessDataExtHelper = new BaseOnlineBusinessDataExtHelper();
