...
import io.wangk.peekaboo.common.flow.object.FlowRuntimeObject;
...
public class FlowOperationHelper {
    ...
    static {
        SYSTEM_VARIABLES.add(FlowEntryVariable.createFlowVariable("processDefinitionName", "流程名称"));
        SYSTEM_VARIABLES.add(FlowEntryVariable.createFlowVariable("processInstanceStartTime", "流程发起时间"));
        SYSTEM_VARIABLES.add(FlowEntryVariable.createFlowVariable("taskName", "流程任务名称"));
        SYSTEM_VARIABLES.add(FlowEntryVariable.createFlowVariable("workOrderCode", "工单编码"));
    }
     ...
     */
    public ResponseResult<FlowRuntimeObject> verifySubmitWithGetInstanceAndTask(
