package io.wangk.peekaboo.common.datafilter.aop;
...
public class DisableDataFilterAspect {
     ...
     */
    @Pointcut("@within(io.wangk.peekaboo.common.core.annotation.DisableDataFilter) " +
            "|| @annotation(io.wangk.peekaboo.common.core.annotation.DisableDataFilter)")
