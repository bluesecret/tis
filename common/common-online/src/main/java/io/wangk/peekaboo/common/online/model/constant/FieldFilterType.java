package io.wangk.peekaboo.common.online.model.constant;
...
public final class FieldFilterType {
    ...
    private static final Map<Object, String> DICT_MAP = new HashMap<>(13);
    static {
        ...
        DICT_MAP.put(NOT_EQUAL, "NOT EQUAL");
        DICT_MAP.put(GREATER_EQUAL, "大于等于");
        DICT_MAP.put(GREATER_THAN, "大于");
        DICT_MAP.put(LESS_EQUAL, "小于等于");
        DICT_MAP.put(LESS_THAN, "小于");
    }
