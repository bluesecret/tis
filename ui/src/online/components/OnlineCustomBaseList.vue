<template>
  <div class="online-custom-base-list" style="height: 100%">
    ...
    >
      <el-row type="flex" style="height: 100%" @click.stop="onWidgetClick(leftWidget)">
    ...
    <div v-show="showFilterDlg" class="filter-dlg">
      <div class="filter">
        <div class="filter-dlg-header">
          ...
          <el-icon class="close"><el-icon-close /></el-icon>
        </div>
...
const form = inject('form', () => {
  console.error('OnlineCustomBaseList: form not injected');
