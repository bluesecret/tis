  ...
  <div class="form-single-fragment third-party-dlg" style="position: relative">
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="24">
          <el-form-item label="关联过滤SQL">
            <el-input
              class="input-item"
              v-model="formData.relationFilterSql"
              type="textarea"
              style="height: 80px"
              :clearable="true"
              placeholder="表关联过滤SQL"
            />
          </el-form-item>
        </el-col>
      </el-row>
  ...
  form.value.validate((valid: boolean) => {
    ...
    let params = {
      onlineDatasourceRelationDto: {
        ...
        relationFilterSql: formData.value.relationFilterSql,
...
const onSlaveTableChange = () => {
  ...
  formData.value.relationFilterSql = undefined;
